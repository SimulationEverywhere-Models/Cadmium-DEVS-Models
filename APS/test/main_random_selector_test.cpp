...
int main(int argc, char ** argv){
    ...
    shared_ptr<dynamic::modeling::model> random_selector1;
    random_selector1 = dynamic::translate::make_dynamic_atomic_model<random_selector, TIME>("random_selector1");
    ...
    submodels_TOP = {input_reader, random_selector1};

    dynamic::modeling::EICs eics_TOP;
    eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP;
    eocs_TOP = {
        dynamic::translate::make_EOC<random_selector_defs::out,top_out>("random_selector1")
    };
    dynamic::modeling::ICs ics_TOP;
    ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<time_series_element>::out,random_selector_defs::in>("input_reader","random_selector1")
    };
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/random_selector_test_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){          
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/random_selector_test_output_state.txt");
