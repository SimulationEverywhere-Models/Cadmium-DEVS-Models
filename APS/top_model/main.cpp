...
#include "../atomics/daily_return_generator.hpp"
...
struct output1 : public out_port<time_series_element>{};
...
int main(int argc, char ** argv) {
    ...
    /****** daily_return_generator atomic model instantiation *******************/
    shared_ptr<dynamic::modeling::model> daily_return_generator1 = dynamic::translate::make_dynamic_atomic_model<daily_return_generator, TIME>("daily_return_generator1");
    ...
    /*******APS SIMULATOR COUPLED MODEL********/
    dynamic::modeling::Ports iports_APS = {typeid(input1)};
    dynamic::modeling::Ports oports_APS = {typeid(output1)};
    dynamic::modeling::Models submodels_APS = {daily_return_generator1, bootstrap_generator};
    dynamic::modeling::EICs eics_APS = {
        dynamic::translate::make_EIC<input1, daily_return_generator_defs::in>("daily_return_generator1")
    };
    dynamic::modeling::EOCs eocs_APS = {
        dynamic::translate::make_EOC<bg_output1, output1>("bootstrap_generator")
    };
    dynamic::modeling::ICs ics_APS = {
        dynamic::translate::make_IC<daily_return_generator_defs::out, bg_input1>("daily_return_generator1","bootstrap_generator"),
    };
    shared_ptr<dynamic::modeling::coupled<TIME>> APS;
    APS = make_shared<dynamic::modeling::coupled<TIME>>(

        "APS", submodels_APS, iports_APS, oports_APS, eics_APS, eocs_APS, ics_APS 
    );
    ...
    dynamic::modeling::Models submodels_TOP = {input_reader, APS};


    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
        dynamic::translate::make_EOC<output1,top_out>("APS")
    };

    dynamic::modeling::ICs ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<time_series_element>::out, input1>("input_reader","APS")
    };
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/APS_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){          
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/APS_output_state.txt");
